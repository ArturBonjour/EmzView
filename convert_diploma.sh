...
echo "  [OK] References / Список источников (new page, 27 entries)"
...
echo "  [OK] All tables (1.1-4.9) and figures (2.1-4.1) referenced in text"
echo ""
echo "  MANUAL STEP — SCREENSHOTS (Figures 3.12–3.15):"
echo "  After opening the generated DOCX, insert actual screenshots:"
echo "    Рис 3.12 → LandingPage (hero section + feature cards)"
echo "    Рис 3.13 → OnboardingPage (poster grid with check-marks)"
echo "    Рис 3.14 → HomePage (six recommendation carousels)"
echo "    Рис 3.15 → SettingsPage (profile, password, theme toggle)"
echo "  Place each screenshot ABOVE its caption line, centered, no indent."
echo ""
echo "========================================================================"
